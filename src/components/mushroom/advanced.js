...
function ESTERILIZACION_SETAS_ADVANCED() {
  return (
    <div>
      <InfoBoxM>
...
function INOCULACION_SETAS_ADVANCED() {
  return (
    <div>
      <InfoBoxM>
...
function INCUBACION_SETAS_ADVANCED() {
  return (
    <div>
      <InfoBoxM>
...
function FRUCTIFICACION_SETAS_ADVANCED() {
  return (
    <div>
      <InfoBoxM>
...
function COSECHA_SETAS_ADVANCED() {
  return (
    <div>
      <InfoBoxM>
...
function SECADO_SETAS_ADVANCED() {
  return (
    <div>
      <InfoBoxM>
