...
function MI_CULTIVO_AUTO() {
  return (
    <div>
      ...
      <SectionTitle>⏱️ CALENDARIO COMPLETO — AUTO 60×60</SectionTitle>
      <div style={{marginBottom:"16px"}}>
        <div style={{fontSize:"14px",color:"#52b788",fontWeight:"bold",marginBottom:"8px"}}>📊 Tabla maestra — autofloreciente en armario 60×60</div>
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:"10px",fontFamily:"monospace"}}>
          <thead><tr style={{background:"#1b4332"}}>{["Sem","Fase","Agua(L)","Frec","Luz%","Altura","Grow","Bloom","Top·Max","Horas"].map(h=><th key={h} style={{padding:"3px 2px",color:"#d8f3dc",borderBottom:"1px solid #2d6a4f",textAlign:"center"}}>{h}</th>)}</tr></thead>
          <tbody>{[["1","Germinar","Spray","1-2d","30%","60cm","—","—","—","18h"],["2","Plántula","0.2L","2-3d","35%","55cm","—","—","—","18h"],["3","Vege","0.5L","2-3d","50%","50cm","0.5","—","—","18h"],["4","LST suave","0.8L","2-3d","60%","45cm","1","—","—","18h"],["5","LST","1.2L","2-3d","70%","40cm","1","—","—","18h"],["6","Estirón+Flora","1.5L","2-3d","80%","35cm","0.5","1","0.5","18h"],["7","Flora","2L","2-3d","90%","30cm","—","2","1","18h"],["8","Flora","2.5L","2-3d","100%","30cm","—","2","1","18h"],["9","Flora","2.5L","2-3d","100%","30cm","—","2","1","18h"],["10","Flora","2.5L","2-3d","100%","30cm","—","2","1","18h"],["11","Engorde","2.5L","3-4d","100%","30cm","—","2","1","18h"],["12","Madura","2L","3-4d","100%","30cm","—","1","0.5","18h"],["13","Flush","2L","3-4d","100%","30cm","—","—","—","18h"],["14","🪴 Cosecha","—","—","off","—","—","—","—","0h"]].map((r,i)=><tr key={i} style={{background:i%2===0?"#0d1f14":"#122318"}}>{r.map((c,j)=><td key={j} style={{padding:"3px 2px",color:j===0?"#52b788":"#95d5b2",borderBottom:"1px solid #1b4332",textAlign:"center",fontWeight:j===0?"bold":"normal"}}>{c}</td>)}</tr>)}</tbody></table>
      </div>
      <div style={{background:"#0d1f14",border:"1px solid #1b4332",borderRadius:"10px",padding:"14px",marginBottom:"16px"}}>
        <div style={{fontSize:"13px",color:"#52b788",fontWeight:"bold",marginBottom:"8px"}}>📝 Cómo leer la tabla</div>
        <ul style={{margin:0,paddingLeft:"16px",fontSize:"12px",color:"#95d5b2",lineHeight:"1.8"}}>
          <li><b>Flora empieza en semana 4-5</b> — las autos florecen por edad, no por cambio de ciclo. Verás pistilos aparecer.</li>
          <li><b>LST suave semanas 4-5</b> — mientras la planta es pequeña, dobla las ramas más altas hacia fuera.</li>
          <li><b>NO hay SCROG</b> — sin malla, la planta crece libremente pero con entrenamiento.</li>
          <li><b>Estirón menor que fotoperiodo</b> — las autos solo se estiran 20-30% al empezar flora, no 2-3x.</li>
        </ul>
      </div>
      <SectionTitle>🥚 Semana 1 — Germinar</SectionTitle>
      <StepX c={CANNABIS_COLORS} num={1} text="Semilla en vaso de agua templada 24h en oscuridad (20-25°C)." />
