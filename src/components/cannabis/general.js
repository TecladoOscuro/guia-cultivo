...
function FAQ() {
  ...
  const faqs = [
    ...
    { sec: "Crecimiento", q: "¿Es necesaria poda LST/topping?", a: "NO necesario para tener cosecha. Sí RECOMENDADO para maximizar: LST (doblar ramas) puede aumentar rendimiento 30-50%. Topping (cortar punta) duplica colas pero estresa. Para autos: LST sí, topping NO." },
