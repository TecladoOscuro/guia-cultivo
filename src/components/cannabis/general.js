...
function FAQ() {
  ...
  const faqs = [
    ...
    { sec: "Crecimiento", q: "¿Cuánto rinde una planta de cannabis?", a: "Interior auto en armario 80x80cm: 50-150g secos por planta. Indoor fotoperiodo bien manejado: 100-300g. Exterior fotoperiodo en bosque/jardín soleado: 200-500g por planta. Variables enormes según luz, espacio raíz, técnica." },
    ...
    { sec: "Setup y clima", q: "¿Cuántos vatios/lúmenes necesito?", a: "Armario 80x80cm: LED 240W reales (NO los 'equivalentes' de marketing). Con eso 2-3 plantas auto. Para fotoperiodo: 320W+. Marcas: Mars Hydro, Spider Farmer, Sunny LED. Evitar LEDs baratos chinos sin specs claras." },
    { sec: "Setup y clima", q: "¿El olor del cultivo es muy fuerte?", a: "Floración últimas 4 semanas: SÍ, MUY fuerte. Sin filtro de carbón = todo el piso huele. Filtro carbón obligatorio para vivienda compartida. Variedades 'low odor' como Northern Lights ayudan pero no eliminan olor totalmente." },
  ];
